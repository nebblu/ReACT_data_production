...
########TRAINING SET################
####################################
training_parameters = np.load('data/npz/fr_spph_params_train_200k.npz')
training_features = np.load('data/npz/fr_spph_boost_train_200k.npz')
...
########TESTING SET################
####################################
testing_parameters = np.load('data/npz/fr_spph_params_test.npz')
testing_features = np.load('data/npz/fr_spph_boost_test.npz')
...
########INSTANIATION################
####################################
model_parameters = ['Omega_m', 'Omega_b', 'Omega_nu', 'H_0', 'n_s', 'A_s', 'f_R0', 'z']
...
cp_nn = cosmopower_NN(restore=True, 
                      restore_filename='mymodels/react_boost_spph_nn_wide_200k_mt',
                      )
...
np.savetxt('BoostSalmon_new.txt', np.c_[k_range, percentiles[0], percentiles[1], percentiles[2]])
...
plt.tight_layout()
plt.savefig('myplots/accuracy_emu_boost_200k.png')
