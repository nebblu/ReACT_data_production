...
CONTAINS
   ...
   SUBROUTINE HMcode_example()
      ...
      TYPE(cosmology) :: cosm
      CHARACTER(len=256) :: aminc
      CHARACTER(len=256) :: amaxc
      CHARACTER(len=256) :: kminc
      CHARACTER(len=256) :: kmaxc
      CHARACTER(len=256) :: nkc
      REAL :: kmin
      REAL :: kmax
      INTEGER :: nk
      REAL :: amin
     ...
     ! INTEGER, PARAMETER :: version = HMcode2020_feedback
      ...
      CALL GET_COMMAND_ARGUMENT(9, aminc)
      CALL GET_COMMAND_ARGUMENT(9, amaxc)
      CALL GET_COMMAND_ARGUMENT(10, nkc)
      CALL GET_COMMAND_ARGUMENT(11, kminc)
      CALL GET_COMMAND_ARGUMENT(12, kmaxc)
      ...
      CALL read_command_argument(8, cosm%Theat, '', def=cosm%Theat)
      
      IF (cosm%Theat==0.) THEN 
             cosm%Theat = 10**8.0
      END IF  
